...
public class GainUnstableHealItem extends Item {

	private Random r = new Random();
	
	public GainUnstableHealItem() {
		this.minDmg = 0;
		this.maxDmg = 0;
		this.level = 1;
		this.minHeal = 1;
		...
		this.name = "Potions";
		this.desc = "Better heals when in UNSTABLE state "+minHeal+"-"+maxHeal;
		...
		this.icon = ss.grabImage(8, 1, 16, 16, 16);
